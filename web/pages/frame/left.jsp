...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010301','0103','班级管理','${pageContext.request.contextPath}/classesFindAll.action','','right');
		...
		d.add('010502','0105','职务管理','${pageContext.request.contextPath}/posts.action','','right');
		d.add('010503','0105','员工管理','${pageContext.request.contextPath}/staffs.action','','right');
